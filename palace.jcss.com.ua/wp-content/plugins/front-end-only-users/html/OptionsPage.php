			...
			<div id='labelling-view-options' class="feup-options-div feup-options-flex">
				...
				<div class='feup-subsection-header'>User Profile</div>
					<div class='feup-subsection-content' id='feup-subsection-inline'>
							...
							<div class='feup-option-input'><input type='text' name='feup_label_please' value='<?php echo $feup_Label_Please; ?>' /></div>
						</div> 
						<div class='feup-option feup-labelling-option'>
							<div class='feup-option-label'>Login</div>
							<div class='feup-option-input'><input type='text' name='feup_label_login' value='<?php echo $feup_Label_Login; ?>' /></div>
						</div> 
						<div class='feup-option feup-labelling-option'>
							<div class='feup-option-label'>To Continue</div>
							<div class='feup-option-input'><input type='text' name='feup_label_to_continue' value='<?php echo $feup_Label_To_Continue; ?>' /></div>
						</div> 
						<div class='feup-option feup-labelling-option'>
							<div class='feup-option-label'>Logout</div>
							<div class='feup-option-input'><input type='text' name='feup_label_logout' value='<?php echo $feup_Label_Logout; ?>' /></div>
						</div> 
						<div class='feup-option feup-labelling-option'>
							<div class='feup-option-label'>Username</div>
							<div class='feup-option-input'><input type='text' name='feup_label_username' value='<?php echo $feup_Label_Username; ?>' /></div>
						</div> 
						<div class='feup-option feup-labelling-option'>
							<div class='feup-option-label'>Register</div>
							<div class='feup-option-input'><input type='text' name='feup_label_register' value='<?php echo $feup_Label_Register; ?>' /></div>
						</div> 
						<div class='feup-option feup-labelling-option'>
							<div class='feup-option-label'>Level</div>
							<div class='feup-option-input'><input type='text' name='feup_label_level' value='<?php echo $feup_Label_Level; ?>' /></div>
						</div> 
						<div class='feup-option feup-labelling-option'>
							<div class='feup-option-label'>Next</div>
							<div class='feup-option-input'><input type='text' name='feup_label_next' value='<?php echo $feup_Label_Next; ?>' /></div>
						</div>
						<div class='feup-option feup-labelling-option'>
							<div class='feup-option-label'>Edit Profile</div>
							<div class='feup-option-input'><input type='text' name='feup_label_edit_profile' value='<?php echo $feup_Label_Edit_Profile; ?>' /></div>
						</div> 
							<div class='feup-option feup-labelling-option'>
							<div class='feup-option-label'>Current file:</div>
							<div class='feup-option-input'><input type='text' name='feup_label_current_file' value='<?php echo $feup_Label_Current_File; ?>' /></div>
						</div> 
							<div class='feup-option feup-labelling-option'>
							<div class='feup-option-label'>Current Picture - </div>
							<div class='feup-option-input'><input type='text' name='feup_label_current_picture' value='<?php echo $feup_Label_Current_Picture; ?>' /></div>
						</div> 
							<div class='feup-option feup-labelling-option'>
							<div class='feup-option-label'>Update Picture - </div>
							<div class='feup-option-input'><input type='text' name='feup_label_update_picture' value='<?php echo $feup_Label_Update_Picture; ?>' /></div>
						</div> 
							<div class='feup-option feup-labelling-option'>
							<div class='feup-option-label'>Discount Code</div>
							<div class='feup-option-input'><input type='text' name='feup_label_discount_code' value='<?php echo $feup_Label_Discount_Code; ?>' /></div>
						</div>
		 				<div class='feup-option feup-labelling-option'>
							<div class='feup-option-label'>Use Discount Code</div>
							<div class='feup-option-input'><input type='text' name='feup_label_use_discount_code' value='<?php echo $feup_Label_Use_Discount_Code; ?>' /></div>
						</div> 
							<div class='feup-option feup-labelling-option'>
							<div class='feup-option-label'>Have a discount code? Enter it below.</div>
							<div class='feup-option-input'><input type='text' name='feup_label_discount_message' value='<?php echo $feup_Label_Discount_Message; ?>' /></div>
						</div> 
					</div> 
				</div> 
				<div class='feup-subsection'>
				<div class='feup-subsection-header'>Update Account</div>
					<div class='feup-subsection-content' id='feup-subsection-inline'>
						<div class='feup-option feup-labelling-option'>
							...
							<div class='feup-option-input'><input type='text' name='feup_label_password' value='<?php echo $feup_Label_Password; ?>' /></div>
						</div> 
						<div class='feup-option feup-labelling-option'>
							<div class='feup-option-label'>Repeat Password</div>
							<div class='feup-option-input'><input type='text' name='feup_label_repeat_password' value='<?php echo $feup_Label_Repeat_Password; ?>' /></div>
						</div>
						<div class='feup-option feup-labelling-option'>
							<div class='feup-option-label'>Password Strength</div>
							<div class='feup-option-input'><input type='text' name='feup_label_password_strength' value='<?php echo $feup_Label_Password_Strength; ?>' /></div>
						</div> 
						<div class='feup-option feup-labelling-option'>
							<div class='feup-option-label'>Reset Password</div>
							<div class='feup-option-input'><input type='text' name='feup_label_reset_password' value='<?php echo $feup_Label_Reset_Password; ?>' /></div>
						</div> 
						<div class='feup-option feup-labelling-option'>
							<div class='feup-option-label'>Upgrade Account</div>
							<div class='feup-option-input'><input type='text' name='feup_label_upgrade_account' value='<?php echo $feup_Label_Upgrade_Account; ?>' /></div>
						</div>
 						<div class='feup-option feup-labelling-option'>
							<div class='feup-option-label'>Update Account</div>
							<div class='feup-option-input'><input type='text' name='feup_label_update_account' value='<?php echo $feup_Label_Update_Account; ?>' /></div>
						</div> 
						<div class='feup-option feup-labelling-option'>
							<div class='feup-option-label'>Email</div>
							<div class='feup-option-input'><input type='text' name='feup_label_email' value='<?php echo $feup_Label_Email; ?>' /></div>
						</div> 
						<div class='feup-option feup-labelling-option'>
							<div class='feup-option-label'>Reset code</div>
							<div class='feup-option-input'><input type='text' name='feup_label_reset_code' value='<?php echo $feup_Label_Reset_Code; ?>' /></div>
						</div> 
						<div class='feup-option feup-labelling-option'>
							<div class='feup-option-label'>Change Password</div>
							<div class='feup-option-input'><input type='text' name='feup_label_change_password' value='<?php echo $feup_Label_Change_Password; ?>' /></div>
						</div> 
						<div class='feup-option feup-labelling-option'>
							<div class='feup-option-label'>Too Short</div>
							<div class='feup-option-input'><input type='text' name='feup_label_too_short' value='<?php echo $feup_Label_Too_Short; ?>' /></div>
						</div> 
						<div class='feup-option feup-labelling-option'>
							<div class='feup-option-label'>Mismatch</div>
							<div class='feup-option-input'><input type='text' name='feup_label_mismatch' value='<?php echo $feup_Label_Mismatch; ?>' /></div>
						</div> 
						<div class='feup-option feup-labelling-option'>
							<div class='feup-option-label'>Weak</div>
							<div class='feup-option-input'><input type='text' name='feup_label_weak' value='<?php echo $feup_Label_Weak; ?>' /></div>
						</div> 
						<div class='feup-option feup-labelling-option'>
							<div class='feup-option-label'>Good</div>
							<div class='feup-option-input'><input type='text' name='feup_label_good' value='<?php echo $feup_Label_Good; ?>' /></div>
						</div> 
						<div class='feup-option feup-labelling-option'>
							<div class='feup-option-label'>Strong</div>
							<div class='feup-option-input'><input type='text' name='feup_label_strong' value='<?php echo $feup_Label_Strong; ?>' /></div>
						</div>
					</div>
				</div>
				<div class='feup-subsection'>
					...
					<div class='feup-subsection-content' id='feup-subsection-inline'>
						<div class='feup-subsection-half'>
							<div class='feup-option feup-labelling-option'>
								...
								<div class='feup-option-input'><input type='text' name='feup_label_successful_logout_message' value='<?php echo $feup_Label_Successful_Logout_Message; ?>' /></div>
							</div> 
							<div class='feup-option feup-labelling-option'>
								<div class='feup-option-label'>Please login to access this content.</div>
								<div class='feup-option-input'><input type='text' name='feup_label_restrict_access_message' value='<?php echo $feup_Label_Restrict_Access_Message; ?>' /></div>
							</div> 
							<div class='feup-option feup-labelling-option'>
								<div class='feup-option-label'>You must be logged in to access this page.</div>
								<div class='feup-option-input'><input type='text' name='feup_label_restricted_message' value='<?php echo $feup_Label_Require_Login_Message; ?>' /></div>
							</div> 
							<div class='feup-option feup-labelling-option'>
								<div class='feup-option-label'>Select the level you'd like to upgrade to using the form below:</div>
								<div class='feup-option-input'><input type='text' name='feup_label_upgrade_level_message' value='<?php echo $feup_Label_Upgrade_Level_Message; ?>' /></div>
							</div> 
							<div class='feup-option feup-labelling-option'>
								<div class='feup-option-label'>Thanks for confirming your e-mail address!</div>
								<div class='feup-option-input'><input type='text' name='feup_label_confirm_email_message' value='<?php echo $feup_Label_Confirm_Email_Message; ?>' /></div>
							</div> 
							<div class='feup-option feup-labelling-option'>
								<div class='feup-option-label'>Please select a valid user profile</div>
								<div class='feup-option-input'><input type='text' name='feup_label_select_valid_profile' value='<?php echo $feup_Label_Select_Valid_Profile; ?>' /></div>
							</div> 
						</div> 
						<div class='feup-subsection-half'>
							<div class='feup-option feup-labelling-option'>
								<div class='feup-option-label'>This content is only for non-logged in users</div>
								<div class='feup-option-input'><input type='text' name='feup_label_nonlogged_message' value='<?php echo $feup_Label_Nonlogged_Message; ?>' /></div>
							</div> 
							<div class='feup-option feup-labelling-option'>
								<div class='feup-option-label'>Sorry, your account level is too low to access this content.</div>
								<div class='feup-option-input'><input type='text' name='feup_label_low_account_level_message' value='<?php echo $feup_Label_Low_Account_Level_Message; ?>' /></div>
							</div> 
							<div class='feup-option feup-labelling-option'>
								<div class='feup-option-label'>Sorry, your account level is too high to access this content.</div>
								<div class='feup-option-input'><input type='text' name='feup_label_high_account_level_message' value='<?php echo $feup_Label_High_Account_Level_Message; ?>' /></div>
							</div> 
							<div class='feup-option feup-labelling-option'>
								<div class='feup-option-label'>Sorry, your account isn't the correct level to access this content.</div>
								<div class='feup-option-input'><input type='text' name='feup_label_wrong_account_level_message' value='<?php echo $feup_Label_Wrong_Account_Level_Message; ?>' /></div>
							</div> 
							<div class='feup-option feup-labelling-option'>
								...
								<div class='feup-option-input'><input type='text' name='feup_label_incorrect_confirm_message' value='<?php echo $feup_Label_Incorrect_Confirm_Message; ?>' /></div>
							</div> 
						</div> 
					</div> 
				</div> 
				...
				<div class='feup-subsection'>
					...
					<div class='feup-subsection-content'>
						...
						<div class='feup-option feup-styling-option'>
							...
							<div class='feup-option-input'><input type='text' class='ewd-feup-spectrum' name='feup_styling_form_font_color' value='<?php echo $feup_Styling_Form_Font_Color; ?>' /></div>
						</div> 
						<div class='feup-option feup-styling-option'>
				...
				<div class='feup-subsection'>
					...
					<div class='feup-subsection-content'>
						<div class='feup-option feup-styling-option'>
							...
							<div class='feup-option-input'><input type='text' class='ewd-feup-spectrum' name='feup_styling_submit_bg_color' value='<?php echo $feup_Styling_Submit_Bg_Color; ?>' /></div>
						</div>
						<div class='feup-option feup-styling-option'>
							<div class='feup-option-label'>Font Family</div>
						...
						<div class='feup-option feup-styling-option'>
							<div class='feup-option-label'>Font Color</div>
							<div class='feup-option-input'><input type='text' class='ewd-feup-spectrum' name='feup_styling_submit_font_color' value='<?php echo $feup_Styling_Submit_Font_Color; ?>' /></div>
						</div>
						<div class='feup-option feup-styling-option'>
				...
				<div class='feup-subsection'>
					...
					<div class='feup-subsection-content'>
						...
						<div class='feup-option feup-styling-option'>
							...
							<div class='feup-option-input'><input type='text' class='ewd-feup-spectrum' name='feup_styling_userlistings_font_color' value='<?php echo $feup_Styling_Userlistings_Font_Color; ?>' /></div>
						</div>
						<div class='feup-option feup-styling-option'>
				...
				<div class='feup-subsection'>
					...
					<div class='feup-subsection-content' id='feup-subsection-inline'>
						...
						<div class='feup-option feup-styling-option'>
							...
							<div class='feup-option-input'><input type='text' class='ewd-feup-spectrum' name='feup_styling_userprofile_label_font_color' value='<?php echo $feup_Styling_Userprofile_Label_Font_Color; ?>' /></div>
						</div>
						<div class='feup-option feup-styling-option'>
						...
						<div class='feup-option feup-styling-option'>
							...
							<div class='feup-option-input'><input type='text' class='ewd-feup-spectrum' name='feup_styling_userprofile_content_font_color' value='<?php echo $feup_Styling_Userprofile_Content_Font_Color; ?>' /></div>
						</div>
					</div>
				</div>
			</div>

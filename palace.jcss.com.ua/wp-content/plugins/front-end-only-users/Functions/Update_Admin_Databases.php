...
function Update_EWD_FEUP_Options() {
	...
	if ($EWD_FEUP_Full_Version == "Yes" and isset($_POST['feup_label_login'])) {update_option("EWD_FEUP_Label_Login", $_POST['feup_label_login']);}
	if ($EWD_FEUP_Full_Version == "Yes" and isset($_POST['feup_label_logout'])) {update_option("EWD_FEUP_Label_Logout", $_POST['feup_label_logout']);}
	if ($EWD_FEUP_Full_Version == "Yes" and isset($_POST['feup_label_username'])) {update_option("EWD_FEUP_Label_Username", $_POST['feup_label_username']);}
	if ($EWD_FEUP_Full_Version == "Yes" and isset($_POST['feup_label_register'])) {update_option("EWD_FEUP_Label_Register", $_POST['feup_label_register']);}
	if ($EWD_FEUP_Full_Version == "Yes" and isset($_POST['feup_label_successful_logout_message'])) {update_option("EWD_FEUP_Label_Successful_Logout_Message", $_POST['feup_label_successful_logout_message']);}
	if ($EWD_FEUP_Full_Version == "Yes" and isset($_POST['feup_label_restricted_message'])) {update_option("EWD_FEUP_Label_Require_Login_Message", $_POST['feup_label_restricted_message']);}
	
	if ($EWD_FEUP_Full_Version == "Yes" and isset($_POST['feup_label_upgrade_account'])) {update_option("EWD_FEUP_Label_Upgrade_Account", $_POST['feup_label_upgrade_account']);}
	if ($EWD_FEUP_Full_Version == "Yes" and isset($_POST['feup_label_upgrade_level_message'])) {update_option("EWD_FEUP_Label_Upgrade_Level_Message", $_POST['feup_label_upgrade_level_message']);}
	if ($EWD_FEUP_Full_Version == "Yes" and isset($_POST['feup_label_level'])) {update_option("EWD_FEUP_Label_Level", $_POST['feup_label_level']);}
	if ($EWD_FEUP_Full_Version == "Yes" and isset($_POST['feup_label_next'])) {update_option("EWD_FEUP_Label_Next", $_POST['feup_label_next']);}
	if ($EWD_FEUP_Full_Version == "Yes" and isset($_POST['feup_label_discount_message'])) {update_option("EWD_FEUP_Label_Discount_Message", $_POST['feup_label_discount_message']);}
	if ($EWD_FEUP_Full_Version == "Yes" and isset($_POST['feup_label_discount_code'])) {update_option("EWD_FEUP_Label_Discount_Code", $_POST['feup_label_discount_code']);}
	if ($EWD_FEUP_Full_Version == "Yes" and isset($_POST['feup_label_use_discount_code'])) {update_option("EWD_FEUP_Label_Use_Discount_Code", $_POST['feup_label_use_discount_code']);}
	if ($EWD_FEUP_Full_Version == "Yes" and isset($_POST['feup_label_edit_profile'])) {update_option("EWD_FEUP_Label_Edit_Profile", $_POST['feup_label_edit_profile']);}
	if ($EWD_FEUP_Full_Version == "Yes" and isset($_POST['feup_label_current_file'])) {update_option("EWD_FEUP_Label_Current_File", $_POST['feup_label_current_file']);}
	if ($EWD_FEUP_Full_Version == "Yes" and isset($_POST['feup_label_current_picture'])) {update_option("EWD_FEUP_Label_Current_Picture", $_POST['feup_label_current_picture']);}
	if ($EWD_FEUP_Full_Version == "Yes" and isset($_POST['feup_label_update_picture'])) {update_option("EWD_FEUP_Label_Update_Picture", $_POST['feup_label_update_picture']);}
	if ($EWD_FEUP_Full_Version == "Yes" and isset($_POST['feup_label_confirm_email_message'])) {update_option("EWD_FEUP_Label_Confirm_Email_Message", $_POST['feup_label_confirm_email_message']);}
	if ($EWD_FEUP_Full_Version == "Yes" and isset($_POST['feup_label_incorrect_confirm_message'])) {update_option("EWD_FEUP_Label_Incorrect_Confirm_Message", $_POST['feup_label_incorrect_confirm_message']);}
	if ($EWD_FEUP_Full_Version == "Yes" and isset($_POST['feup_label_select_valid_profile'])) {update_option("EWD_FEUP_Label_Select_Valid_Profile", $_POST['feup_label_select_valid_profile']);}
	if ($EWD_FEUP_Full_Version == "Yes" and isset($_POST['feup_label_nonlogged_message'])) {update_option("EWD_FEUP_Label_Nonlogged_Message", $_POST['feup_label_nonlogged_message']);}
	if ($EWD_FEUP_Full_Version == "Yes" and isset($_POST['feup_label_low_account_level_message'])) {update_option("EWD_FEUP_Label_Low_Account_Level_Message", $_POST['feup_label_low_account_level_message']);}
	if ($EWD_FEUP_Full_Version == "Yes" and isset($_POST['feup_label_high_account_level_message'])) {update_option("EWD_FEUP_Label_High_Account_Level_Message", $_POST['feup_label_high_account_level_message']);}
	if ($EWD_FEUP_Full_Version == "Yes" and isset($_POST['feup_label_wrong_account_level_message'])) {update_option("EWD_FEUP_Label_Wrong_Account_Level_Message", $_POST['feup_label_wrong_account_level_message']);}
	if ($EWD_FEUP_Full_Version == "Yes" and isset($_POST['feup_label_restrict_access_message'])) {update_option("EWD_FEUP_Label_Restrict_Access_Message", $_POST['feup_label_restrict_access_message']);}

	if ($EWD_FEUP_Full_Version == "Yes" and isset($_POST['feup_label_please'])) {update_option("EWD_FEUP_Label_Please", $_POST['feup_label_please']);}
	if ($EWD_FEUP_Full_Version == "Yes" and isset($_POST['feup_label_to_continue'])) {update_option("EWD_FEUP_Label_To_Continue", $_POST['feup_label_to_continue']);}
	if ($EWD_FEUP_Full_Version == "Yes" and isset($_POST['feup_label_password'])) {update_option("EWD_FEUP_Label_Password", $_POST['feup_label_password']);}
	if ($EWD_FEUP_Full_Version == "Yes" and isset($_POST['feup_label_repeat_password'])) {update_option("EWD_FEUP_Label_Repeat_Password", $_POST['feup_label_repeat_password']);}
	if ($EWD_FEUP_Full_Version == "Yes" and isset($_POST['feup_label_password_strength'])) {update_option("EWD_FEUP_Label_Password_Strength", $_POST['feup_label_password_strength']);}
	if ($EWD_FEUP_Full_Version == "Yes" and isset($_POST['feup_label_reset_password'])) {update_option("EWD_FEUP_Label_Reset_Password", $_POST['feup_label_reset_password']);}
	if ($EWD_FEUP_Full_Version == "Yes" and isset($_POST['feup_label_email'])) {update_option("EWD_FEUP_Label_Email", $_POST['feup_label_email']);}
	if ($EWD_FEUP_Full_Version == "Yes" and isset($_POST['feup_label_reset_code'])) {update_option("EWD_FEUP_Label_Reset_Code", $_POST['feup_label_reset_code']);}
	if ($EWD_FEUP_Full_Version == "Yes" and isset($_POST['feup_label_change_password'])) {update_option("EWD_FEUP_Label_Change_Password", $_POST['feup_label_change_password']);}
	if ($EWD_FEUP_Full_Version == "Yes" and isset($_POST['feup_label_too_short'])) {update_option("EWD_FEUP_Label_Too_Short", $_POST['feup_label_too_short']);}
	if ($EWD_FEUP_Full_Version == "Yes" and isset($_POST['feup_label_mismatch'])) {update_option("EWD_FEUP_Label_Mismatch", $_POST['feup_label_mismatch']);}
	if ($EWD_FEUP_Full_Version == "Yes" and isset($_POST['feup_label_weak'])) {update_option("EWD_FEUP_Label_Weak", $_POST['feup_label_weak']);}
	if ($EWD_FEUP_Full_Version == "Yes" and isset($_POST['feup_label_good'])) {update_option("EWD_FEUP_Label_Good", $_POST['feup_label_good']);}
	if ($EWD_FEUP_Full_Version == "Yes" and isset($_POST['feup_label_strong'])) {update_option("EWD_FEUP_Label_Strong", $_POST['feup_label_strong']);}

					...
					<div id="rt-footer">
						<div class="rt-authorized-form">
							...
							<p class="rt-authorized-login-message">
								<?php _re('This gizmo hides your WordPress site behind the Coming Soon page with its Countdown timer. You can still access the frontend of the site by logging in as an administrator below. You can customize this message in the Plethora theme language file.'); ?>
							</p>
